...
- В данный момент изучаю **JavaScript** (**ReactJS**, **ReduxJS**, **ElectronJS**) и **Python**👀
- Есть опыт в разрабоке Discord ботов на **Python** и **nodeJS** используя библиотеки **Disnake** и **discord.js** соответсвенно
